  ...
  <div class="album py-5 bg-light">
    ...
    <nav class="navbar bg-body-tertiary">
      <form class="container-fluid justify-content-start">
        ...
        <a href="index_calificaciones.php" class="btn btn-info me-2" type="button"><i class="bi bi-list-ol"></i> Calificaciones</a>
      ...
      <div class="mb-4">
        <p><span id="seccion_MX"></span>
          <p class="h2">
            <div class="alert alert-info h2 text-center" role="alert">
              <i class="bi bi-flag-fill text-info"></i> Calificaciones 
            </div>
          </p>
        </p>
