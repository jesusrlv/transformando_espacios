  ...
  <div class="album py-5 bg-light">
    ...
    <nav class="navbar bg-body-tertiary">
      <form class="container-fluid justify-content-start">
        <a href="index_completados.php" class="btn btn-outline-success btn-sm me-2" type="button"><i class="bi bi-check-circle-fill"></i> Completados</a>
        <a href="index_no_completados.php" class="btn btn-danger me-2" type="button"><i class="bi bi-x-circle-fill"></i> No completados</a>
        ...
        <p><span id="seccion_MX"></span>
          <p class="h2">
            <div class="alert alert-danger h2 text-center" role="alert">
              <i class="bi bi-flag-fill text-danger"></i> Postulantes expediente no completo 
            </div>
          </p>
        </p>
